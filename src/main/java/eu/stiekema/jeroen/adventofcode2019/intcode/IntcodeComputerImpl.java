...
public class IntcodeComputerImpl implements IntcodeComputer {

    private Context context;

    private IntcodeComputerImpl(List<Long> codes, Queue<Long> input) {
        this.context = new Context(new Memory(codes), input);
    }

    private IntcodeComputerImpl(IntcodeComputerImpl intcodeComputer) {
        this.context = intcodeComputer.context.copy();
    }

    @Override
    public IntcodeComputerImpl copy() {
        return new IntcodeComputerImpl(this);
    }

    public static IntcodeComputerImpl newInstance(List<Long> codes) {
        return new IntcodeComputerImpl(codes, new LinkedList<>());
    }
